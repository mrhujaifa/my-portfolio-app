...
export default function ProjectTitle({
  title = "Projects",
  subtitle = "Explore a selection of my recent web development projects — each built with a strong focus on clean design, responsive layouts, seamless functionality, and optimized performance using modern JavaScript technologies like React, Node.js, and MongoDB.",
}) {
